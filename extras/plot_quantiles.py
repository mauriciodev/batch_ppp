...
@hydra.main(version_base=None, config_path="../configurations", config_name="plot_quantiles")
def my_app(cfg : DictConfig) -> None:
    ...
    plt.tight_layout()
    plt.savefig(f"percentiles.pdf", bbox_inches="tight")
...
#models = ['rtklib_ionfree', 'spp_rtklib_ionex','spp_rtklib_c1pg', 'rtklib_brdc', 'edconvlstm_nd', 'unet']
#for model in models:
#    calc(folder.format(model=model))
