...
def run_rt_ppp(ppp_executable, obsFile, outFile, template_conf, replaceDict, cwd = '.'):
...
def run_rtklib(ppp_executable, obsFile, navFile, template_conf, replaceDict, cwd = '.'):
